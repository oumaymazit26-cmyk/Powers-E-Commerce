-- ============================================================
-- POWERS E-Commerce v2.0 - Base de données MySQL
-- Ajouts: Audit Log, RBAC, Draft/Live, Archive
-- ============================================================
...
-- ============================================================
-- 1. TABLE USERS (Utilisateurs avec RBAC)
-- ============================================================
...
-- ============================================================
-- 2. TABLE AUDIT_LOGS (Journal d'Audit)
-- ============================================================
...
-- ============================================================
-- 3. TABLE CATEGORIES (Hiérarchique)
-- ============================================================
...
-- ============================================================
-- 4. TABLE PRODUCTS (Produits avec Draft/Live & Archive)
-- ============================================================
CREATE TABLE IF NOT EXISTS products (
    ...
    INDEX idx_wp_sync (wp_sync_status),
    INDEX idx_scheduled (scheduled_publish_at)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- ============================================================
-- 5. INSERTION DES CATÉGORIES RÉELLES
-- ============================================================
-- ==================== 1. CLIMATISATION ====================
